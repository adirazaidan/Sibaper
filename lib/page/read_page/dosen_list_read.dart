...
import 'package:sibaperr/page/read_page/baplistread.dart';

class DosenListReadPage extends StatefulWidget {
  const DosenListReadPage({super.key});

  @override
  State<DosenListReadPage> createState() => _DosenListReadPageState();
}

class _DosenListReadPageState extends State<DosenListReadPage> {
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => BapListReadPage(
                        dosen: dosen,
