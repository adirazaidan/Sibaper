...
import 'package:sibaperr/page/read_page/mhs_bapread.dart';

class MhsBapListReadPage extends StatefulWidget {
  final Dosen dosen;
  final String selectedMatkul;
  final String selectedKelas;

  const MhsBapListReadPage({super.key, required this.dosen, required this.selectedMatkul, required this.selectedKelas});

  @override
  _MhsBapListReadPageState createState() => _MhsBapListReadPageState();
}

class _MhsBapListReadPageState extends State<MhsBapListReadPage> {
  @override
